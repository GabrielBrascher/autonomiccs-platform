...
public class HypervisorManagerTest {
    ...
    public void shutdownHostTestFull() {
        HostVO host = setTestOfShutdownHost(HypervisorType.XenServer, Host.Type.Routing, true);
    ...
    public void shutdownHostTestNotRoutingHost() {
        HostVO host = setTestOfShutdownHost(HypervisorType.XenServer, Host.Type.ConsoleProxy, true);
        hypervisorManager.shutdownHost(host);
    ...
    public void shutdownHostTestNotXenServer() {
        HostVO host = setTestOfShutdownHost(HypervisorType.XenServer, Host.Type.Routing, false);
        hypervisorManager.shutdownHost(host);
    ...
    private void verifyShutdownHostCalledMethods(int supportsHypervisorTimes, int shutdownTimes) {
        Mockito.verify(hypervisor, Mockito.times(supportsHypervisorTimes)).supportsHypervisor(HypervisorType.XenServer);
    ...
    private HostVO setTestOfShutdownHost(HypervisorType hypervisorType, Host.Type hostType, boolean supportsHypervisor) {
        HostVO host = new HostVO("");
